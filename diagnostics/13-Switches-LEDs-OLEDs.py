...
pixels.show()
oled1.fill(0)
oled1.text("Press Buttons", 0, 0)
oled1.show()
oled2.fill(0)
oled2.text("Press Buttons", 0, 0)
oled2.show()
    ...
    while(True):
        ...
        if gpio0input0 != "0b11111111":
            ...
            if bit == "0b0":
                ...
                oled2.text("Brightness:", 0, 10)
                oled2.text(str(led_brightness), 90, 10)
                oled2.text("R:   G:   B:", 0, 20)
                oled2.text(str(led_red), 15, 20)
                oled2.text(str(led_green), 55, 20)
                oled2.text(str(led_blue), 96, 20)
                oled2.show()
            ...
            if bit == "0b0":
                ...
                oled1.text("Brightness:", 0, 10)
                oled1.text(str(led_brightness), 90, 10)
                oled1.text("R:   G:   B:", 0, 20)
                oled1.text(str(led_red), 15, 20)
                oled1.text(str(led_green), 55, 20)
                oled1.text(str(led_blue), 96, 20)
                oled1.show()
