...
#Assumes that the sliders, OLEDS, and speaker are working
...
if len(devices0) == 0 or len(devices1) == 0: 
    ...
    while(True):
        ...
        while(True):
            if ball_screen == 1:
                oled1.fill(0)
                oled1.hline(oled_width - paddle_width - paddle1_x,paddle1_y,paddle_width,white)
                oled1.rect(ball_x,ball_y,ball_width,ball_height,white)
                oled1.show()
                
                oled2.fill(0)
                oled2.hline(paddle2_x,paddle2_y,paddle_width,white)
                oled2.show()
            else:
                oled1.fill(0)
                oled1.hline(oled_width - paddle_width - paddle1_x,paddle1_y,paddle_width,white)
                ...
                oled2.fill(0)
                oled2.hline(paddle2_x,paddle2_y,paddle_width,white)
                oled2.rect(ball_x,ball_y,ball_width,ball_height,white)
                oled2.show()
            ...
            if ball_y == 0:
                ...
                ball_y_increase = True #Change the ball Y direction
                
                ball_x_increase = not ball_x_increase #Change the ball X direction
            
                ball_x = oled_width - ball_x #The screens are rotated 180 degrees so we need adjust the X
